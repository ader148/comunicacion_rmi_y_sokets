...
public class Conexion_cliente_servidor {
    ...
    /*public InformacionDTO peticion_respuesta(){
     ...
     public InformacionDTO peticion_respuesta(ArrayList<HamburguesaDTO> listaHamburguesas){
        String tmp = null;
        try {
            
            //escribimos en el canal la factura con los datos
            //creamos el objeto infromacionDTO
            InformacionDTO informacion = new InformacionDTO();
            //llenamos los campos de informacionDTO
            informacion.setHamburguesas(listaHamburguesas);
            informacion.setIvaPedido(12500); //todo calcular
            informacion.setSubtotalPedido(35000); //todo calcular
            informacion.setTotalPedido(55000); //todo calcular
            
            String InformacionConvertida =  ConversorJson.objectToJson(informacion);
            
            //flujoSalida.writeUTF("caracteristicas");
            flujoSalida.writeUTF(InformacionConvertida);
